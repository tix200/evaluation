      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          <li class="nav-item active">
            <a class="nav-link" href="<?= base_url() ?>loginUtilisateur/logout">deconnexion <span class="sr-only">(current)</span></a>
          </li>
          <li class="nav-item">
    ...
    <div class="container" >
      <div class="row">
        <div id="block1" class="col-md-12">
          <h2 class="h2">Ajout D'Echeance</h2>
          <form action="<?= base_url() ?>ajoutEcheance/add" method="post">
