    ...
    <div class="container" >
      <div class="row">
        <div id="block1" class="col-md-12">
          <h2 class="h2">Ajout De trajet</h2>
          <form action="<?= base_url() ?>ajoutTrajet/add" method="post">
              ...
              <p>Carburant : 
                  <input class="form-control form-control-lg" type="number" name="carburant"required >
              </p>
               <p>DateDepart : 
                  <input class="form-control form-control-lg" type="date" name="dateDepart" required>
              </p>
               <p>DateArrive : 
                  <input class="form-control form-control-lg" type="date" name="dateArrive" required>
              </p>
               <p>LieuArrive : 
               ...
               <p>PrixCarburant : 
                  <input class="form-control form-control-lg" type="number" name="prixCarburant" required>
              </p>
               <p>Motif : 
              ...
              <p>kilometrageArrive : 
                  <input class="form-control form-control-lg" type="number" name="kilometrageArrive" required>
              </p>
              <p>HeureArrive : 
                  <input class="form-control form-control-lg" type="number" name="heureArrive" required>
              </p>
              <p>HeureDepart : 
