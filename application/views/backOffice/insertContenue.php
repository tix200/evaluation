<html lang="en">
  <head>
    ...
    <title>Insertion De Voiture</title>
    <script>
    ...
    <div class="container" >
      <div class="row">
        <div id="block1" class="col-md-12">
          <h2 class="h2">Insertion De Voiture</h2>
          <form action="<?= base_url() ?>backOffice/add" method="post"  enctype="multipart/form-data">
              <p>Numero : 
                  <input class="form-control form-control-lg" type="text" name="numero">
              </p>
              <p>Marque : 
                  <input class="form-control form-control-lg" type="text" name="marque">
              </p>
              <p>Modele : 
                  <input class="form-control form-control-lg" type="text" name="modele">
              </p>
               <p>Type : 
