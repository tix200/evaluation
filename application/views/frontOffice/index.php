...
<header class="header">
    ...
    <nav class="navbar">
        ...
        <a href="#vehicles">Voiture Disponible</a>
...
<section class="vehicles" id="vehicles">
    ...
    <h1 class="heading"> Voitures <span>Disponible</span> </h1>
    ...
    <div class="swiper vehicles-slider">
        ...
        <div class="swiper-wrapper">
            ...
            <?php   
            foreach ($voitureDispo->result() as $row)
                {
                    echo 
                        '
                            <div class="swiper-slide box">
                                ...
                                <div class="content">
                                    <h3>Numero : '.$row->numero.'</h3>
                                    <a href="#" class="btn">Carnet de suivie</a>
                                </div>
                            </div>
                        ';
                }
...
<section class="vehicles" id="vehicles">
    ...
    <h1 class="heading">Besoin d <span>'Entretien </span> </h1>
...
<section class="vehicles" id="vehicles">
    ...
    <h1 class="heading"><span>Echeance</span> </h1>
...
<section class="reviews" id="reviews">
    ...
    <h1 class="heading"> Les <span>Chauffeurs</span> </h1>
